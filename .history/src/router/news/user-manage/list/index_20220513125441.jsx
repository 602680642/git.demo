...
export default function User() {
 ...
 const columns = [
  ...
  
  {
    title: '用户状态',
    dataIndex: 'roleState',
    render:(roleState,items) => <Switch checked = {roleState} disabled = {items.default}></Switch>
  },
  {
    title: '操作',
    ...
    render:(items)=>{
      ...
      return <div>
         ...
         content = {<Switch checked = {items.roleState} onChange={()=> permisson(items)}></Switch>}>
           ...
           <Button type = 'primary' shape='circle' icon = {<EditOutlined/>} disabled = disabled = {items.default}/>
         </Popover>
      </div>
    }
  },
