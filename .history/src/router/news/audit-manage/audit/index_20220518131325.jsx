 ...
 const columns = [
...

  {
    ...
    render: (items) => {
      ...
      return <div>
        <Button type='primary' onClick={() => {handleAudit(items,2,)}} shape='circle' icon={<CheckOutlined />} style={{ marginRight: '10px' }} />

        <Button danger shape='circle' icon={<CloseOutlined />} onClick={() => {handleAudit(items)}}
        />
