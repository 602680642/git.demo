...
import {HomeOutlined, UserOutlined,KeyOutlined,AuditOutlined,ReconciliationOutlined,SolutionOutlined} from '@ant-design/icons';
...
//图标列表
 ...
 function Aside(props) {
  ...
  return (
    ...
    <Sider width={200} style={{ background: '#fff' }} trigger={null} collapsibl collapsed={collapsed}>
