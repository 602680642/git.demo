...
export default function Corouter() {
  return (
    <Switch>
            ...
            <Route path= '/publish-manage/published' component = {UserList}/>
            <Route path= '/publish-manage/unpublished' component = {List1}/>
            <Route path= '/publish-manage/sunset' component = {List2}/>
    </Switch>
  )
}
