...
'/home' component = {Home}/>
'/user-manage/list' component = {UserList}/>
'/right-manage/right' component = {List1}/>
'/right-manage/role' component = {List2}/>
'/audit-manage/audit' component = {Audit}/>
'/audit-manage/list' component = {AuditList}/>
'/news-manage/add' component = {NewsAdd}/>
'/news-manage/draft' component = {NewsDraft}/>
'/news-manage/category' component = {NewsCategory}/>
'/publish-manage/published' component = {Publish}/>
'/publish-manage/unpublished' component = {UnPublish}/>
'/publish-manage/sunset' component = {PublishSunset}/>
