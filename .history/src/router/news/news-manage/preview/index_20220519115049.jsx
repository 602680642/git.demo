...
export default function NewsPreview(props) {
  ...
  useEffect(()=>{
    ...
    axios.get(`/news/${props.match.params.id}?_expand=categry&_expand=role`).then(res =>{
  ...
  return (
    ...
    
    {
     ...
     newinfo && <div className="site-page-header-ghost-wrapper">   
      <PageHeader
      ghost={false}
    ...
    >
      <Descriptions size="small" column={3} >
        ...
        <Descriptions.Item label="审核状态">
          {auditList[newinfo.auditState]}
        </Descriptions.Item>
        <Descriptions.Item label="发布状态" >
        {publishList[newinfo.publishState]}
        </Descriptions.Item>
